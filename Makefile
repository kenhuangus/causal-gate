.PHONY: install dev verify-demo verify-benchmark verify-adapters verify-web verify-clean verify-release verify-recorded-analysis verify-live-analysis generate-recorded-analysis
...
verify-release: verify-demo verify-benchmark verify-adapters verify-recorded-analysis verify-web
